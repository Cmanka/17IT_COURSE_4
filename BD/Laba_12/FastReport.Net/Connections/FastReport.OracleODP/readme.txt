...
- you need Oracle ODP.NET to be installed. Obtain it
at http://www.oracle.com/technology/software/tech/windows/odpnet/index.html;
- open the .sln file;
...
- check that "Oracle.DataAccess.dll" reference is correct. 
