<?php
$image_dir_path = $_SERVER['DOCUMENT_ROOT'] . "/Tasks/Laba_9/photo/";
...
if (isset($_POST["MAX_FILE_SIZE"]))
 ...
 "/Tasks/Laba_9/photo/".$_FILES["file_upload"]["name"];
 echo $tmp_file_name;
...
if ($array_files_count)
 ...
 {
 ?>
 <p><a href="/Tasks/Laba_9/photo/<?php echo $array_files[$i]; ?>"
 target="_blank">
...
if (isset($_POST["file_delete"]))
 { 
 $file_name = $_SERVER['DOCUMENT_ROOT'] . "/Tasks/Laba_9/photo/".
 $_POST["file_delete"];
